	  ...
	  <a href="#">
        <div class="panel panel-default movie-poster">
		  ...
		  <div id="hover-caption" style="text-align:center" class="caption animated">
					...
					<p><button style="width:100%" type="button" class="btn btn-info"><span class="glyphicon glyphicon glyphicon-eye-open"></span>  explore</button></p>
